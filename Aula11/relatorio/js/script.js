...
window.onload = function() {
  // Terminou de carregar
   ...
   let acElement = document.getElementById('inputProva')
   let provaElement = document.getElementById('inputAC')
   let mediaElement = document.getElementById('inputMedia')

   var tabela = document.getElementById('tabelaAluno');

   escutaAlteracoes(acElement, provaElement, mediaElement, tabela.rows[0])
};
...
function adicionarLinha() {
    ...
    celula6.innerHTML =  "<input type='text' class='form-control' disabled>"
...
function gerarRelatorio() {
    ...
    for (let entrada of entradas) {
      doc.text(entrada.value, metade , 50 + espaco, 'center');
      espaco = espaco + 10
    }
