...
function adicionarLinha() {
    ...
    celula2.innerHTML =  "<input type='text' class='form-control'>"
    celula3.innerHTML =  "<input type='text' class='form-control'>"
    celula4.innerHTML =  "<input type='text' class='form-control' onchange='calculaMediaInputs(linha)'>"
    celula5.innerHTML =  "<input type='text' class='form-control' onchange='calculaMediaInputs(linha)'>"
    celula6.innerHTML =  "<input type='text' class='form-control'>"
 ...
 */
 ...
 function calculaMediaInputs(linha) {
  var media = 0.7 * Number(linha.cells[3].innerHTML.value) + 0.3 * Number(linha.cells[4].innerHTML.value)
  console.log(media)
}
 ...
 function calculaMedia() {
  ...
  var prova = document.getElementById('inputProva')
  var atividade = document.getElementById('inputAC')
  var inputMedia = document.getElementById('inputMedia')
  var media = 0.7 * Number(prova.value) + 0.3 * Number(atividade.value)
  inputMedia.value = media.toPrecision(2)
  console.log(0.7 * prova.value + 0.3 * atividade.value)
 }